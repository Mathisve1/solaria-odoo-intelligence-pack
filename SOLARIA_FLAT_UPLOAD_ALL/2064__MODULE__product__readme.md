# Module Intelligence Pack — `product` (Products & Pricelists)

> Product master data: templates/variants, attributes, UoM, pricing basics. Shared by Sales, Purchase, Inventory, Manufacturing, POS, eCommerce.
...
| `models.json` | Source-derived data model (33 models defined/extended) | Verifying objects/fields/relations exist |
