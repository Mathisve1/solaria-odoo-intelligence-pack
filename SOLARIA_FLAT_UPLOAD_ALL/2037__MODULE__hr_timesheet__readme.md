# Module Intelligence Pack — `hr_timesheet` (Task Logs)

> Time capture on projects/tasks; feeds costing and (with sale_timesheet) billing.

| Attribute | Value |
|---|---|
| Source origin | community (Odoo 19.0) |
| Functional domain | Timesheets |
