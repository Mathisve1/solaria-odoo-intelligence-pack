# Module Intelligence Pack — `industry_fsm` (Field Service)

> Enterprise field service: work orders as tasks with timers, worksheets, materials and on-site invoicing.
...
| `models.json` | Source-derived data model (17 models defined/extended) | Verifying objects/fields/relations exist |
