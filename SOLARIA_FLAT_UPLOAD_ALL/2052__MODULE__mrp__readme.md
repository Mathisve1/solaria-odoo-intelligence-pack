# Module Intelligence Pack — `mrp` (Manufacturing)

> Manufacturing: BoMs, manufacturing orders, work centers, unbuild/scrap — the plan-to-produce core.
...
| `models.json` | Source-derived data model (52 models defined/extended) | Verifying objects/fields/relations exist |
