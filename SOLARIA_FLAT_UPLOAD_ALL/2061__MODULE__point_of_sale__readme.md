# Module Intelligence Pack — `point_of_sale` (Point of Sale)

> Offline-capable store selling: sessions, payments, receipts, restaurant mode — synced to stock and accounting.

| Attribute | Value |
|---|---|
| Source origin | community (Odoo 19.0) |
| Functional domain | Point of Sale |
...
| `models.json` | Source-derived data model (70 models defined/extended) | Verifying objects/fields/relations exist |
