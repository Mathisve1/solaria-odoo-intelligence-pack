# Module Intelligence Pack — `approvals` (Approvals)

> Enterprise generic approval requests: categories, approver matrices, statuses — first stop before custom approval flows.

| Attribute | Value |
|---|---|
| Source origin | enterprise (Odoo 19.0) |
| Functional domain | Approvals |
...
| `models.json` | Source-derived data model (8 models defined/extended) | Verifying objects/fields/relations exist |
