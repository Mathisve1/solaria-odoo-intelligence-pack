# Module Intelligence Pack — `contacts` (Contacts)

> The Contacts app: single partner master (customers, vendors, companies, persons) shared by every business flow.
...
| `models.json` | Source-derived data model (2 models defined/extended) | Verifying objects/fields/relations exist |
