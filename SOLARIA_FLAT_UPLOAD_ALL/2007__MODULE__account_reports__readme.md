# Module Intelligence Pack — `account_reports` (Accounting Reports)

> The Enterprise statutory & management reporting engine: Balance Sheet, P&L, Cash Flow, Trial Balance, ledgers, tax reports and automated account returns — the CFO/compliance layer.
...
| `models.json` | Source-derived data model (68 models defined/extended) | Verifying objects/fields/relations exist |
