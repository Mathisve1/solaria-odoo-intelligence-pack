# Module Intelligence Pack — `marketing_automation` (Marketing Automation)

> Enterprise campaign journeys: multi-step automated flows on top of email marketing with triggers and A/B logic.

| Attribute | Value |
|---|---|
| Source origin | enterprise (Odoo 19.0) |
| Functional domain | Marketing Automation |
...
| `models.json` | Source-derived data model (11 models defined/extended) | Verifying objects/fields/relations exist |
