# Module Intelligence Pack — `stock` (Inventory)

> Warehouse operations: locations, routes, pickings, lots/serials, reordering, valuation hooks.
...
| `models.json` | Source-derived data model (63 models defined/extended) | Verifying objects/fields/relations exist |
