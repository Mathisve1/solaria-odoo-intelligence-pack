# Module Intelligence Pack — `base_automation` (Automation Rules)

> Community automation rules engine: trigger→condition→action on any model — the platform's standard answer to 'when X happens, do Y' without code.
...
| `models.json` | Source-derived data model (3 models defined/extended) | Verifying objects/fields/relations exist |
