# Module Intelligence Pack — `account` (Invoicing)

> Invoicing core (Community): customer invoices, vendor bills, payments, taxes, journals — the financial spine. Enterprise layers (account_accountant, account_reports) extend it into full Accounting.
...
| `models.json` | Source-derived data model (89 models defined/extended) | Verifying objects/fields/relations exist |
