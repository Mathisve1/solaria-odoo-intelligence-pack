# Module Intelligence Pack — `hr_recruitment` (Recruitment)

> Hiring pipeline: jobs, applicants, stages, interviewers, offers — attract-to-hire.

| Attribute | Value |
|---|---|
| Source origin | community (Odoo 19.0) |
| Functional domain | Recruitment |
