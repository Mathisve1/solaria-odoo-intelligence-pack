# Module Intelligence Pack — `website_sale` (eCommerce)

> eCommerce on the website platform: catalog, cart, checkout, payments — natively wired to stock and invoicing.
...
| `models.json` | Source-derived data model (36 models defined/extended) | Verifying objects/fields/relations exist |
