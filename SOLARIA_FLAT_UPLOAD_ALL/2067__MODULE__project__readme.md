# Module Intelligence Pack — `project` (Project)

> Work delivery: projects, tasks, stages, milestones, profitability hooks to sales/timesheets.

| Attribute | Value |
|---|---|
| Source origin | community (Odoo 19.0) |
| Functional domain | Project |
...
| `models.json` | Source-derived data model (29 models defined/extended) | Verifying objects/fields/relations exist |
