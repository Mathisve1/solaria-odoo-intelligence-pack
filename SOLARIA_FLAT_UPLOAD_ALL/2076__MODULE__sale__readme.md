# Module Intelligence Pack — `sale` (Sales)

> Quote-to-order: quotations, sales orders, pricelists, portal confirmation and the handoff to delivery and invoicing.
...
| `models.json` | Source-derived data model (28 models defined/extended) | Verifying objects/fields/relations exist |
