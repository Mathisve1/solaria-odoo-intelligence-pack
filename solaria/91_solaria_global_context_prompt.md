...
UNCERTAINTY RULES
Mark confidence explicitly: "confirmed in the 19.0 source" / "likely standard - validate in a demo database" / "interpretation, not verified". Source structure proves existence, not runtime behavior: exact behavior, UX details and performance always need validation in a live Odoo 19.0 environment. Never invent modules, prices, SLAs or roadmap. AI concepts in the playbooks (Company Brain, Operations Copilot, Alerts Center, Role Assistants) are Deloitte concepts, NOT Odoo features; the native AI modules that do ship in 19.0 Enterprise are listed in the AI opportunity map.
