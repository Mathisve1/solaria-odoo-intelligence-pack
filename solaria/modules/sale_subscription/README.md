# Module Intelligence Pack — `sale_subscription` (Subscriptions)

> Enterprise recurring business: subscription orders, automated recurring invoicing, renewals, MRR/churn analytics.
...
| `models.json` | Source-derived data model (27 models defined/extended) | Verifying objects/fields/relations exist |
