# Usage Instructions — modules/sale_subscription/security_summary.md

| Field | Value |
|---|---|
| Document name | `modules/sale_subscription/security_summary.md` |
...
Role design baselines, permission questions, segregation-of-duties discussions involving `sale_subscription`.
...
> Security baseline of the Odoo 19.0 `sale_subscription` module (Enterprise): shipped groups, access rights and record rules with Deloitte advisory notes. Use as the starting point for role design; the client's actual security model must be designed and tested per project.
