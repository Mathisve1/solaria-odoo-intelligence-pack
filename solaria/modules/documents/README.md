# Module Intelligence Pack — `documents` (Documents)

> Enterprise DMS: workspaces, tags, workflow actions that turn files into business records (e.g., PDF to vendor bill).

| Attribute | Value |
|---|---|
| Source origin | enterprise (Odoo 19.0) |
| Functional domain | Documents |
...
| `models.json` | Source-derived data model (24 models defined/extended) | Verifying objects/fields/relations exist |
