# Module Intelligence Pack — `purchase` (Purchase)

> Procure-to-pay front end: RFQs, purchase orders, vendor pricing, receipt and billing control.

| Attribute | Value |
|---|---|
| Source origin | community (Odoo 19.0) |
| Functional domain | Purchase |
