# Module Intelligence Pack — `website` (Website)

> Website builder and public web platform: pages, menus, multi-site, visitors — the front-office foundation.

| Attribute | Value |
|---|---|
| Source origin | community (Odoo 19.0) |
| Functional domain | Website |
...
| `models.json` | Source-derived data model (58 models defined/extended) | Verifying objects/fields/relations exist |
