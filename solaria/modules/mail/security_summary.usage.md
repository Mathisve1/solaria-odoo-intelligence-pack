# Usage Instructions — modules/mail/security_summary.md

| Field | Value |
|---|---|
| Document name | `modules/mail/security_summary.md` |
...
Role design baselines, permission questions, segregation-of-duties discussions involving `mail`.
...
> Security baseline of the Odoo 19.0 `mail` module (Community): shipped groups, access rights and record rules with Deloitte advisory notes. Use as the starting point for role design; the client's actual security model must be designed and tested per project.
