# Module Intelligence Pack — `helpdesk` (Helpdesk)

> Enterprise ticketing: teams, stages, SLA policies, ratings — care-to-resolution.

| Attribute | Value |
|---|---|
| Source origin | enterprise (Odoo 19.0) |
| Functional domain | Helpdesk |
...
| `models.json` | Source-derived data model (19 models defined/extended) | Verifying objects/fields/relations exist |
