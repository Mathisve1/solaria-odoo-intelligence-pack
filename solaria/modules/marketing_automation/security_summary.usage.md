# Usage Instructions — modules/marketing_automation/security_summary.md

| Field | Value |
|---|---|
| Document name | `modules/marketing_automation/security_summary.md` |
...
Role design baselines, permission questions, segregation-of-duties discussions involving `marketing_automation`.
...
> Security baseline of the Odoo 19.0 `marketing_automation` module (Enterprise): shipped groups, access rights and record rules with Deloitte advisory notes. Use as the starting point for role design; the client's actual security model must be designed and tested per project.
