# Usage Instructions — modules/product/security_summary.md

| Field | Value |
|---|---|
| Document name | `modules/product/security_summary.md` |
...
Role design baselines, permission questions, segregation-of-duties discussions involving `product`.
...
> Security baseline of the Odoo 19.0 `product` module (Community): shipped groups, access rights and record rules with Deloitte advisory notes. Use as the starting point for role design; the client's actual security model must be designed and tested per project.
