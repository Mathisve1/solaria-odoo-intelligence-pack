# Module Intelligence Pack — `account_accountant` (Invoicing)

> The Enterprise Accounting layer on Community Invoicing: reconciliation workbench with auto-reconcile, fiscal years, governed lock dates — what turns 'Invoicing' into 'Accounting'.
...
| `models.json` | Source-derived data model (20 models defined/extended) | Verifying objects/fields/relations exist |
