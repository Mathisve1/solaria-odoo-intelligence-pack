# Usage Instructions — modules/account_accountant/security_summary.md

| Field | Value |
|---|---|
| Document name | `modules/account_accountant/security_summary.md` |
...
Role design baselines, permission questions, segregation-of-duties discussions involving `account_accountant`.
...
> Security baseline of the Odoo 19.0 `account_accountant` module (Enterprise): shipped groups, access rights and record rules with Deloitte advisory notes. Use as the starting point for role design; the client's actual security model must be designed and tested per project.
