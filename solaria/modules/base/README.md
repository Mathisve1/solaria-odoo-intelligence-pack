# Module Intelligence Pack — `base` (Base)

> Framework foundation: companies, users, partners base, countries, currencies, ir.* infrastructure. Everything depends on it; clients never 'buy' it, but architects reason with it.
...
| `models.json` | Source-derived data model (126 models defined/extended) | Verifying objects/fields/relations exist |
