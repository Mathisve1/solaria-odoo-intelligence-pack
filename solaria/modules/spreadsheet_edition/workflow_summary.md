# Workflow & Automation Summary — `spreadsheet_edition` (Odoo 19.0)
...
- Collaboration flow: insert live data → co-edit → cell threads (comments) → revision history for rollback — governance-friendly analytics.
- Data refresh is pull-from-live-models; scheduled snapshots/dashboards are separate features — validate exact refresh semantics live.
