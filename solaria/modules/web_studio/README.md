# Module Intelligence Pack — `web_studio` (Studio)

> Enterprise no-code customization: fields, views, apps, report editing AND Studio approval rules — the governed alternative to custom development for data/UI shape.

| Attribute | Value |
|---|---|
| Source origin | enterprise (Odoo 19.0) |
| Functional domain | Studio / Customization |
...
| `models.json` | Source-derived data model (35 models defined/extended) | Verifying objects/fields/relations exist |
